  ...
  return (
    <aside className="flex h-screen w-60 flex-col bg-base-100 border-r border-base-300/40 relative z-20">
      ...
      <nav className="flex-1 overflow-y-auto px-3 py-4">
        <p className="px-3 mb-2 text-[10px] font-semibold uppercase tracking-widest text-base-content/40">Navigation</p>
            ...
            return (
              <li key={item.name}>
                <Link href={item.href} className={cn(
                  ...
                  isActive ? "bg-primary text-primary-content shadow-sm" : "text-base-content/60 hover:bg-base-200/80 hover:text-base-content"
                )}>
      ...
      <div className="p-3 border-t border-base-300/40">
        <button onClick={handleLogout} className="btn btn-ghost btn-sm w-full justify-start gap-2.5 text-base-content/50 hover:text-error hover:bg-error/8 rounded-lg text-[13px] font-medium h-9">
